...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nama_siswa', $jadwal->nama_siswa ?? auth()->user()->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                  ...
                  <option value="XII TKR 2" <?php echo e(old('kelas', $jadwal->kelas ?? (auth()->user()->kelas?->nama_kelas ?? '')) == 'XII TKR 2' ? 'selected' : ''); ?>>XII TKR 2</option>
                  <option value="XII RPL" <?php echo e(old('kelas', $jadwal->kelas ?? (auth()->user()->kelas?->nama_kelas ?? '')) == 'XII RPL' ? 'selected' : ''); ?>>XII RPL</option>
                  <option value="XII TPM 4" <?php echo e(old('kelas', $jadwal->kelas ?? (auth()->user()->kelas?->nama_kelas ?? '')) == 'XII TPM 4' ? 'selected' : ''); ?>>XII TPM 4</option>
                  <option value="XII TITL" <?php echo e(old('kelas', $jadwal->kelas ?? (auth()->user()->kelas?->nama_kelas ?? '')) == 'XII TITL' ? 'selected' : ''); ?>>XII TITL</option>
                </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('absen', $jadwal->absen ?? auth()->user()->absen)); ?>" required>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\bk_ukk2526\resources\views/jadwal_konseling/form.blade.php ENDPATH**/ ?>