...
<div class="pc-content">
    ...
    <form method="POST" action="<?php echo e(route('guru_bk.store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <a href="<?php echo e(route('guru_bk.index')); ?>" class="btn btn-secondary">Batal</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\bk_ukk\resources\views/guru_bk/create.blade.php ENDPATH**/ ?>