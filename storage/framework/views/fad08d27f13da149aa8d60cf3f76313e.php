...
<html lang="en">
    ...
    <head>
        ...
        <title><?php echo $__env->yieldContent('title'); ?> - Aplikasi BK SMK</title>
        <!-- [Meta] -->
        <meta charset="utf-8">
        ...
        <nav class="navbar navbar-expand-md navbar-dark top-nav-collapse default py-0">
            <div class="container">
                    <a class="navbar-brand" href="/">
                        <img width="70" src="<?php echo e(asset('assets/images/my/logosekolah.png')); ?>" alt="logo">
                </a>
...
<?php /**PATH C:\Users\Lenovo\ukk2526\resources\views/layouts/landing.blade.php ENDPATH**/ ?>