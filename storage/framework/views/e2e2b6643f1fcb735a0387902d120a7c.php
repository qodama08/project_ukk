...
<div class="row">
    <div class="col-md-3">
        <div class="card border-left-primary shadow-sm">
            <div class="card-body">
                ...
                <div class="h3 mb-0 font-weight-bold text-primary"><?php echo e($totalSiswa); ?></div>
            </div>
            <a href="<?php echo e(url('/siswa')); ?>" class="card-footer bg-white">
    ...
    <div class="col-md-3">
        <div class="card border-left-success shadow-sm">
            <div class="card-body">
                ...
                <div class="h3 mb-0 font-weight-bold text-success"><?php echo e($totalGuruBK); ?></div>
            </div>
            <a href="<?php echo e(url('/guru_bk')); ?>" class="card-footer bg-white">
    ...
    <div class="col-md-3">
        <div class="card border-left-info shadow-sm">
            <div class="card-body">
                ...
                <div class="h3 mb-0 font-weight-bold text-info"><?php echo e($totalJadwal); ?></div>
            </div>
            <a href="<?php echo e(url('/jadwal_konseling')); ?>" class="card-footer bg-white">
    ...
    <div class="col-md-3">
            ...
            <div class="card-body">
                ...
                <div class="h3 mb-0 font-weight-bold text-warning"><?php echo e($totalPrestasi); ?></div>
            </div>
            <a href="<?php echo e(url('/prestasi')); ?>" class="card-footer bg-white">
                <span class="small">Lihat →</span>
            </a>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <a href="<?php echo e(url('/pelanggaran')); ?>" class="text-decoration-none">
    ...
    <div class="col-md-3 mb-3">
        <a href="<?php echo e(url('/prestasi')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm hover">
                <div class="card-body text-center">
    ...
    <div class="col-md-3 mb-3">
        <a href="<?php echo e(url('/jadwal_konseling')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm hover">
                <div class="card-body text-center">
    ...
    <div class="col-md-3 mb-3">
        <a href="<?php echo e(url('/catatan_konseling')); ?>" class="text-decoration-none">
            <div class="card h-100 shadow-sm hover">
                <div class="card-body text-center">
...
<?php /**PATH C:\Users\PC_\bk_ukk2526\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>