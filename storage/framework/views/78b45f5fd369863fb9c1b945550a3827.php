    ...
    <body>
        ...
        <div class="auth-main">
            <div class="auth-wrapper v3">
                <div class="auth-form"
                    style="background-image: url(<?php echo e(asset('assets/images/my/logosekolah.png')); ?>);background-size:cover;">
                    <div class="auth-header">
                        <a class="navbar-brand" href="/">
                            <img width="100" src="<?php echo e(asset('assets/images/my/logosekolah.png')); ?>" alt="logo">
                        </a>
                    </div>
...
<?php /**PATH C:\Users\Lenovo\ukk2526\resources\views/layouts/auth.blade.php ENDPATH**/ ?>