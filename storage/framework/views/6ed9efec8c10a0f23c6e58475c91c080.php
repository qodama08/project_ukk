    ...
    <table class="table table-striped">
      ...
      <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          ...
          <td><?php echo e($n->jadwal->nama_siswa ?? ($n->siswa->name ?? '-')); ?></td>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\bk_ukk2526\resources\views/catatan_konseling/index.blade.php ENDPATH**/ ?>