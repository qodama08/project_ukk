  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="mb-3">
        ...
        <input type="number" name="absen" class="form-control @error('absen') is-invalid @enderror" value="{{ old('absen') }}">
    ...
    <div class="col-md-6">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="nomor_hp_wali" class="form-control @error('nomor_hp_wali') is-invalid @enderror" value="{{ old('nomor_hp_wali') }}">
