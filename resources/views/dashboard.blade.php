            ...
            <div class="col-md-6 col-lg-3">
                <div class="card" style="border-left: 4px solid #4680ff; border-radius: 8px;">
                    <div class="card-body">
                        ...
                        <div class="h2 mb-0 text-primary" style="font-weight: 700;">{{ $totalSiswa }}</div>
                        <small class="text-muted">Siswa aktif</small>
                        <div class="mt-3">
                            <a href="{{ route('siswa.index') }}" class="text-primary" style="text-decoration: none; font-size: 0.9rem; font-weight: 500;">Lihat Data →</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card" style="border-left: 4px solid #2ed8b6; border-radius: 8px;">
                    <div class="card-body">
                        ...
                        <div class="h2 mb-0" style="color: #2ed8b6; font-weight: 700;">{{ $totalGuruBK }}</div>
                        <small class="text-muted">Guru pembimbing</small>
                        <div class="mt-3">
                            <a href="{{ route('siswa.index') }}" class="text-success" style="text-decoration: none; font-size: 0.9rem; font-weight: 500;">Kelola →</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card" style="border-left: 4px solid #a0d468; border-radius: 8px;">
                    <div class="card-body">
                        ...
                        <div class="h2 mb-0" style="color: #a0d468; font-weight: 700;">{{ $totalJadwal }}</div>
                        <small class="text-muted">Jadwal terjadwal</small>
                        <div class="mt-3">
                            <a href="{{ route('jadwal_konseling.index') }}" class="text-success" style="text-decoration: none; font-size: 0.9rem; font-weight: 500;">Lihat →</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card" style="border-left: 4px solid #ffd500; border-radius: 8px;">
                    <div class="card-body">
                        ...
                        <div class="h2 mb-0" style="color: #ffd500; font-weight: 700;">{{ $totalPrestasi }}</div>
                        <small class="text-muted">Pencapaian siswa</small>
                        <div class="mt-3">
                            <a href="{{ route('prestasi.index') }}" class="text-warning" style="text-decoration: none; font-size: 0.9rem; font-weight: 500;">Lihat →</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-4">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    <a href="{{ route('pelanggaran.index') }}" class="text-decoration-none">
                ...
                <div class="col-md-3 mb-3">
                    <a href="{{ route('jadwal_konseling.index') }}" class="text-decoration-none">
                        <div class="card h-100" style="border-radius: 8px; transition: all 0.3s ease;">
                            <div class="card-body text-center p-4">
                                <div class="mb-3" style="font-size: 2.5rem;">📅</div>
                ...
                @if ($isAdmin || $user->roles()->where('nama_role', 'guru_wali_kelas')->exists())
                <div class="col-md-3 mb-3">
